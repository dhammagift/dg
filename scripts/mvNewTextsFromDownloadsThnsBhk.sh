...
trndir=$apachesitepath/assets/texts/en_other/sutta/
thtrndir=$apachesitepath/assets/texts/en_other/sutta/
...
#en trn 
for file in `find "$lbldir" -maxdepth 1 -type f -size +0 -name "*translation-en-*.json" 2>/dev/null`
do 
