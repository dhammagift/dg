...
$ctaButtons =' <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-center align-items-center my-3 mb-2">
    ...
    <a class="ms-2 mb-2" href="https://t.me/dgift_bot">
        <img src="/assets/img/buttons/telegram-cta.png" class="cta-img" title="Открыть DGift_bot. Или наберите @DGift_bot в любом Телеграм чате или группе">
    </a>
    ...
    <a class="ms-2 mb-2" href="https://chromewebstore.google.com/detail/dhammagift-search-and-wor/dnnogjdcmhbiobpnkhdbfnfjnjlikabd">
        <img src="/assets/img/buttons/chrome-cta.png" class="cta-img" title="Скачать из Chrome Web Store. Поддерживается в Chrome, Edge, Opera, Brave, Vivaldi и Yandex Browser.">
    </a>

    <a class="ms-2 mb-2" href="https://addons.mozilla.org/en-US/firefox/addon/dhamma-gift/">
        <img src="/assets/img/buttons/firefox-cta.png" class="cta-img" title="Скачать из Firefox Add-ons">
    </a>
...
$tooltipsearchbar = '
<strong>Автоподсказки</strong>: введите от 3 символов — будут появляться подсказки из пали слов Четырёх Никай (DN, MN, SN, AN), а также части KN (Dhp, Iti, Ud, Snp) и всех разделов Винаи. Из редиацкции Mahasangiti, варианты из других редакций не выводятся.
<br><br>
<strong>Количество совпадений</strong> (например, mettā 27) показывает, сколько раз слово встречается в текстах указанных выше. Для более широких результатов ищите без приставок и/или окончаний.
<br><br>
...
$aboutprp = '<div class="col-lg-4 ms-auto"><p class="lead">Dhamma.Gift — это поисковая система Освобождения. Точный Поиск в текстах Дхаммы и Винаи, в ядре Палийского Канона с результатами в удобных таблицах с построчными переводами и ссылками на другие сайты. Вы можете искать и отфильтровывать понятия, определения, метафоры, объяснения, людей, места и другое описанное в Суттах и Винае на Пали, Русском, Английском и Тайском. Или читать и слушать тексты полностью. </p></div>
<div class="col-lg-4 me-auto"><p class="lead">Если вы разработчик или просто хотите помочь с развитием сайта - будем вам рады.<br><br>Проект не нуждается, в материальной помощи, но если вы хотите поучаствовать в оплате за доменное имя, пожалуйста, свяжитесь удобным вам способом из блока "Контакты". </p></div>';
...
$ifEnThanTrn = '<span class="small text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Thanissaro Bhikkhu">TB</span>';
$ifEnSujTrn = '<span class="small text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Bhikkhu Sujato">BS</span>';
...
$tooltipsearchbar = '<strong>Autosuggestions</strong>: Start typing at least 3 characters - suggestions will appear with Pali words of the Mahasangiti Edition. From the Four Nikāyas (DN, MN, SN, AN), from the part of KN (Dhp, Iti, Ud, Snp) and all Vinaya divisions. Does not include variants from other editions.
<br><br>
<strong>Match count</strong> e.g., mettā 27 shows how many times the word appears in texts listed above. For broader results, search for words in their base form without prefixes or case endings.
<br><br>
<strong>Open texts</strong>: Enter a reference e.g., sn56.11, DN 22, Sn 12 2, an10.46, mn141 - you will also see the Pāli text name in suggestions.
<br><br>
...
$anamelearnsanskrit = 'James Whelan. Pali & Sanskrit';
...
$aboutprp = '<div class="col-lg-4 ms-auto"><p class="lead">Dhamma.Gift is a Liberation Search Engine for Dhamma and Vinaya, core of the Pali Canon. </br></br>Search results in informative filterable tables with line by line translations and external links. You can search in Pali, English, Russian, Thai for meanings, definitions, metaphors, explanations, people, places, and more as described in the Suttas and Vinaya. Or read and listen whole text.</p></div>
...
$ctaButtons =' <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-center align-items-center my-3 mb-2">
    ...
    <a class="ms-2 mb-2" href="https://t.me/dgift_bot">
        <img src="/assets/img/buttons/telegram-cta.png" class="cta-img" title="Open DGift_bot. Or type @DGift_bot in any Telegram chat or group">
    </a>
    ...
    <a class="ms-2 mb-2" href="https://chromewebstore.google.com/detail/dhammagift-search-and-wor/dnnogjdcmhbiobpnkhdbfnfjnjlikabd">
        <img src="/assets/img/buttons/chrome-cta.png" class="cta-img" title="Download from Chrome Web Store. Supports Chrome, Edge, Opera, Brave, Vivaldi, and Yandex Browser.">
    </a>

    <a class="ms-2 mb-2" href="https://addons.mozilla.org/en-US/firefox/addon/dhamma-gift/">
        <img src="/assets/img/buttons/firefox-cta.png" class="cta-img" title="Download from Firefox Add-ons">
    </a>
...
[
    'title' => 'ปฏิจจสมุปบาทสามลักษณะ',
    'desc'  => 'ลำดับเหตุปัจจัย ๑๐ ประการ ๑๑ ประการ และ ๑๒ ประการ ตามที่ปรากฏในพระสูตรต่าง ๆ',
    'link'  => '/?q=%28N%C4%81mar%C5%ABpapaccay%C4%81+vi%C3%B1%C3%B1%C4%81%E1%B9%87a%7Csn12.2.%2AVibha%E1%B9%85gasutt%29&p=-kn',
],       
           [
        'title' => 'พระตถาคตกับการยังไม่ทรงประกาศสัมมาสัมโพธิญาณ',
        'desc'  => 'ข้อความในพระสูตรที่กล่าวถึงช่วงเวลาก่อนการประกาศความตรัสรู้สูงสุด เพื่อประโยชน์แก่ผู้มุ่งสู่ความหลุดพ้น',
        'link'  => '/?q=y%C4%81vak%C4%ABva%C3%B1.%2AAnuttara%E1%B9%81+samm%C4%81sambodh&p=-kn',
    ], 
           [
        'title' => 'ระยะเวลาแห่งการบรรลุธรรม สำหรับบรรพชิตและคฤหัสถ์',
        'desc'  => 'การกล่าวถึงระยะเวลาแห่งการอบรมปฏิบัติ ตามพระพุทธพจน์',
        'link'  => '/assets/example/(viharanto-yathaa-mayaanusi.t.tha.m-eva.m-bhaaveyya)_suttanta_pali_3-16.html',
    ],
               [
        'title' => 'ความหมายของทุกข์ในพระสูตร',
        'desc'  => 'การพิจารณาความหมายของคำว่า “ทุกข์” ตามการใช้ถ้อยคำในพระพุทธศาสนา',
        'link'  => '/assets/example/kata.,-dukkha.m-question_suttanta_pali_3-3.html',
    ],
    
                   [
        'title' => 'บุคคลประเภทต่าง ๆ ในคำสอนของพระตถาคต',
        'desc'  => 'การจำแนกบุคคลตามพระสูตร ตั้งแต่ ๓ ประเภท ไปจนถึง ๑๐ ประเภท',
        'link'  => '/?q=Pugg.*saṁvijjam.*lokasmiṁ',
    ],        
           [
        'title' => 'ความเสื่อมและความไม่เสื่อมในคำสอนของพระตถาคต',
        'desc'  => 'ตัวอย่างลักษณะแห่งความเสื่อมและไม่เสื่อม ตามที่กล่าวไว้ในพระสูตร',
        'link'  => '/?q=Parihānametaṁ',
    ]
];
