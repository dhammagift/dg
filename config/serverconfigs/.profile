...
#FDG related
alias asset="cd $basedir/assets/texts/ru/sutta/"
...
alias ssssh='ssh pasha@163.5.29.37'
...
alias sclpull="sshcommit && git pull --rebase"
alias gp="git pull"
alias gpall='find . -type d -name ".git" -execdir sh -c "echo \">> Updating \$(pwd)\"; git pull --rebase" \;'


#alias cf='bash scripts/checkForMTinSCrepo.sh'

function cf() {
apa
echo mv 
bash scripts/mvNewTextsFromDownloadsThnsBhk.sh	
echo check
bash scripts/checkForMTinSCrepo.sh
cd -
...
alias gitall="git pull --rebase ; yes '' | commit_and_push ; sshpull ; ssh -p1000 root@94.126.201.8 'cd /var/www/html ; bash scripts/checknewlinebylineinscrepo.sh' ; yes '' | sshcommit ; git pull --rebase"
#alias miss='apa 2>&1 >/dev/null ; bash  scripts/mvNewTextsFromDownloads.sh; bash ./scripts/missingtranslations.sh an5; git pull --rebase; cd - 2>&1 >/dev/null'
...
alias dpd='cd /data/data/com.termux/files/usr/share/apache2/default-site/dpd-ui'
apachectl start
