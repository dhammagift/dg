...
/* const hintSettings = {
    patterns: {
        '/ru/result/': {
            title: 'Подсказка:',
            message: 'Чтобы открыть текст с нужного места, кликните по невидимой ссылке ✦ в начале или в нижнем правом углу фрагмента.'
        },
        '/result/': {
            title: 'Hint:',
            message: 'To open the text from a specific location, click the invisible link ✦ at the beginning or lower right corner of the fragment.'
        },
        '/r/': {
            title: 'Подсказка:',
            message: 'Чтобы скопировать цитату со ссылкой, кликните по невидимой ссылке ✦ в начале или в нижнем правом углу фрагмента. Длинное нажатие или правый клик копирует только ссылку.'
        },
        '/read/': {
            title: 'Hint:',
            message: 'To copy a quote with a link, click the invisible link ✦ at the beginning or lower right corner of the line. Long press or right-click copies only the link.'
        }
    }
};
*/
