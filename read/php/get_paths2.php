...
// --- НОВАЯ ЛОГИКА: ФИЛЬТРАЦИЯ ПЕРЕВОДЧИКОВ ---
$translatorInfo = [];
...
if (file_exists($trJsonPath)) {
    ...
    // Функция для извлечения ID из имени файла: ..._translation-lang-ID.json
...
//curl -s "http://localhost:8080/read/php/get_paths2.php?slug=mn1" | jq