...
4. если нужно свертиться с пали то коренные тексты лежат здесь /var/www/html/suttacentral.net/sc-data/sc_bilara_data/root/pli/ms/ там sutta  vinaya и файлы с такими же индексами и ключами json
